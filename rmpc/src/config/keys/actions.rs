...
impl From<GlobalActionFile> for GlobalAction {
    fn from(value: GlobalActionFile) -> Self {
        match value {
            ...
            GlobalActionFile::Pause => GlobalAction::Pause,
            GlobalActionFile::Unpause => GlobalAction::Unpause,
...
impl ToDescription for GlobalAction {
    fn to_description(&self) -> Cow<'static, str> {
        match self {
            ...
            GlobalAction::Pause => "Pause playback".into(),
            GlobalAction::Unpause => "Unpause playback".into(),
