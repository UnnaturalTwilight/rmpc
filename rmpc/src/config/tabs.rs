...
pub struct Pane {
    ...
    pub border_active_style: Option<StyleConfig>,
...
pub enum SizedPaneOrSplit {
    ...
    Split {
        ...
        borders: Borders,
        border_style: Option<StyleConfig>,
...
impl PaneOrSplitFile {
    ...
    pub fn convert_recursive(
        ...
        bg_col: Option<Color>,
        b: Borders,
        b_style: Option<StyleConfig>,
        b_active_style: Option<StyleConfig>,
