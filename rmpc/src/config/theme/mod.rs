...
pub struct SymbolsFile {
    ...
    pub(super) song_highlighted_style: Option<StyleFile>,
    pub(super) dir_highlighted_style: Option<StyleFile>,
    pub(super) playlist_highlighted_style: Option<StyleFile>,
    pub(super) marker_highlighted_style: Option<StyleFile>,
...
pub struct SymbolsConfig {
    ...
    pub song_highlighted_style: Option<Style>,
    pub dir_highlighted_style: Option<Style>,
    pub playlist_highlighted_style: Option<Style>,
    pub marker_highlighted_style: Option<Style>,
    ...
    fn from(value: SymbolsFile) -> Self {
        Self {
            ...
            marker_style: value
                ...
                .transpose()
                .unwrap_or_default(),
            song_highlighted_style: value
                .song_highlighted_style
                .map(|s| s.to_config_or(None, None))
                .transpose()
                .unwrap_or_default(),
            dir_highlighted_style: value
                .dir_highlighted_style
                .map(|s| s.to_config_or(None, None))
                .transpose()
                .unwrap_or_default(),
            playlist_highlighted_style: value
                .playlist_highlighted_style
                .map(|s| s.to_config_or(None, None))
                .transpose()
                .unwrap_or_default(),
            marker_highlighted_style: value
                .marker_highlighted_style
                .map(|s| s.to_config_or(None, None))
                .transpose()
                .unwrap_or_default(),
